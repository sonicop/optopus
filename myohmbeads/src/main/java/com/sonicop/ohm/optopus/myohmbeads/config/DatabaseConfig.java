...
@EntityScan(basePackages = "com.sonicop.ohm.optopus.myohmbeads.model")
@EnableJpaRepositories(transactionManagerRef = "transactionManager",
                       entityManagerFactoryRef = "entityManagerFactory",
                       basePackages = "com.sonicop.ohm.optopus.myohmbeads.repository")
public class DatabaseConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    emf.setPackagesToScan("com.sonicop.ohm.optopus.myohmbeads.model");
